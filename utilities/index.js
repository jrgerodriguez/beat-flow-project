...
Util.getProximos = async function (req, res, next) {
  try {
    ...
    console.error("Error en getProximos:", error.message);
    return ""; // Devuelve HTML vacío para que igual cargue la página
  }
};
      ...
      <div class="evento-list-element">
        ...
        <div class="evento-list-element__contenido">
          ...
          <div class="evento-list-element__contenido-botones">
            <a href="/evento/editar-evento/${row.evento_id}" class="boton-accion editar">Editar</a>
